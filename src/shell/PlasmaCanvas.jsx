/* reusable WebGL plasma background — the IQ cosine palette shader,
   lifted from the original manifesto Hero so the homepage hero can
   reuse the exact same violet/magenta/acid look. */
...
export default function PlasmaCanvas({ className }) {
